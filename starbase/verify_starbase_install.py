...
if not files_only:
    for name in (
        ...
        "starbase_economics", "starbase_fees", "starbase_fleet", "starbase_fleet_ui", "starbase_dataset_library", "starbase_dataset_library_ui", "starbase_golden", "starbase_golden_ui", "starbase_live", "starbase_live_ui", "starbase_live_transition", "starbase_live_transition_ui", "starbase_workspaces", "tooltips",
    ):
