...
required_files = [
    ...
    "starbase_fleet.py", "starbase_fleet_ui.py", "starbase_dataset_library.py", "starbase_dataset_library_ui.py", "starbase_golden.py", "starbase_golden_ui.py", "starbase_live.py", "starbase_live_ui.py", "starbase_live_profiles_v1.json", "starbase_workspaces.py", "tooltips.py", "logo_dark.png", "logo_light.png",
]
...
if not files_only:
    for name in (
        ...
        "starbase_economics", "starbase_fees", "starbase_fleet", "starbase_fleet_ui", "starbase_dataset_library", "starbase_dataset_library_ui", "starbase_golden", "starbase_golden_ui", "starbase_live", "starbase_live_ui", "starbase_workspaces", "tooltips",
    ):
